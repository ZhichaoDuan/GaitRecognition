...
_C.PATH = CN()
# output dir
_C.PATH.OUTPUT_DIR = '/home/duanzhichao/experiments/gait-recognition'
# experiment name
...
# dataset settings
_C.DATASET = CN()
_C.DATASET.DATASET_DIR = '/home/duanzhichao/datasets/GaitDatasetB-silh-processed'
...
# has to be one of 'normal', 'smooth', 'none' or 'hard'
